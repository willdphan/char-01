...
{
  new (message_memory) ros2_pkg::srv::TurnCamera_Request(_init);
}

void TurnCamera_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros2_pkg::srv::TurnCamera_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TurnCamera_Request_message_member_array[1] = {
  {
    ...
    offsetof(ros2_pkg::srv::TurnCamera_Request, degree_turn),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TurnCamera_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(ros2_pkg::srv::TurnCamera_Request),
...
{
  return &::ros2_pkg::srv::rosidl_typesupport_introspection_cpp::TurnCamera_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_pkg, srv, TurnCamera_Request)() {
  return &::ros2_pkg::srv::rosidl_typesupport_introspection_cpp::TurnCamera_Request_message_type_support_handle;
}
...
void TurnCamera_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) ros2_pkg::srv::TurnCamera_Response(_init);
}

void TurnCamera_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros2_pkg::srv::TurnCamera_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TurnCamera_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_pkg::srv::TurnCamera_Response, camera_image),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TurnCamera_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(ros2_pkg::srv::TurnCamera_Response),
...
{
  return &::ros2_pkg::srv::rosidl_typesupport_introspection_cpp::TurnCamera_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_pkg, srv, TurnCamera_Response)() {
  return &::ros2_pkg::srv::rosidl_typesupport_introspection_cpp::TurnCamera_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers TurnCamera_service_members = {
  ...
  // see get_service_type_support_handle<ros2_pkg::srv::TurnCamera>()
...
get_service_type_support_handle<ros2_pkg::srv::TurnCamera>()
{
  ...
  auto service_type_support =
    &::ros2_pkg::srv::rosidl_typesupport_introspection_cpp::TurnCamera_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_pkg, srv, TurnCamera)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<ros2_pkg::srv::TurnCamera>();
}
