...
class Navigate_Goal(metaclass=Metaclass_Navigate_Goal):
    ...
    def __init__(self, **kwargs):
        ...
        from geometry_msgs.msg import Point
        self.goal_point = kwargs.get('goal_point', Point())
    ...
    def goal_point(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'goal_point' field must be a sub message of type 'Point'"
...
class Navigate_Feedback(metaclass=Metaclass_Navigate_Feedback):
    ...
    def __init__(self, **kwargs):
        assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
            'Invalid arguments passed to constructor: %s' % \
            ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        self.distance_to_point = kwargs.get('distance_to_point', float())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.distance_to_point != other.distance_to_point:
            return False
        return True
    ...
    def distance_to_point(self):
        """Message field 'distance_to_point'."""
        return self._distance_to_point

    @distance_to_point.setter
    def distance_to_point(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'distance_to_point' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'distance_to_point' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._distance_to_point = value
...
class Navigate_SendGoal_Request(metaclass=Metaclass_Navigate_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'ros2_pkg/Navigate_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['ros2_pkg', 'action'], 'Navigate_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from ros2_pkg.action._navigate import Navigate_Goal
...
class Metaclass_Navigate_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ros2_pkg.action.Navigate_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from ros2_pkg.action import _navigate
...
class Navigate_SendGoal(metaclass=Metaclass_Navigate_SendGoal):
    from ros2_pkg.action._navigate import Navigate_SendGoal_Request as Request
    from ros2_pkg.action._navigate import Navigate_SendGoal_Response as Response
...
class Navigate_GetResult_Response(metaclass=Metaclass_Navigate_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'ros2_pkg/Navigate_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['ros2_pkg', 'action'], 'Navigate_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from ros2_pkg.action._navigate import Navigate_Result
...
class Metaclass_Navigate_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ros2_pkg.action.Navigate_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Navigate_GetResult(metaclass=Metaclass_Navigate_GetResult):
    from ros2_pkg.action._navigate import Navigate_GetResult_Request as Request
    from ros2_pkg.action._navigate import Navigate_GetResult_Response as Response
...
class Metaclass_Navigate_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ros2_pkg.action.Navigate_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Navigate_FeedbackMessage(metaclass=Metaclass_Navigate_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'ros2_pkg/Navigate_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['ros2_pkg', 'action'], 'Navigate_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from ros2_pkg.action._navigate import Navigate_Feedback
...
class Navigate(metaclass=Metaclass_Navigate):
    ...
    from ros2_pkg.action._navigate import Navigate_Goal as Goal
    # The result message defined in the action definition.
    from ros2_pkg.action._navigate import Navigate_Result as Result
    # The feedback message defined in the action definition.
    from ros2_pkg.action._navigate import Navigate_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from ros2_pkg.action._navigate import Navigate_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from ros2_pkg.action._navigate import Navigate_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from ros2_pkg.action._navigate import Navigate_FeedbackMessage as FeedbackMessage
