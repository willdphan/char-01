...
#include "ros2_pkg/action/detail/navigate__rosidl_typesupport_fastrtps_c.h"
...
using _Navigate_Goal__ros_msg_type = ros2_pkg__action__Navigate_Goal;
  ...
  void * untyped_ros_message)
{
  ...
  _Navigate_Goal__ros_msg_type * ros_message = static_cast<_Navigate_Goal__ros_msg_type *>(untyped_ros_message);
  // Field name: goal_point
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _Navigate_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_pkg__action__Navigate_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_pkg
size_t max_serialized_size_ros2_pkg__action__Navigate_Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_pkg__action__Navigate_Goal;
    is_plain =
      (
...
static size_t _Navigate_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_pkg__action__Navigate_Goal(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_pkg, action, Navigate_Goal)() {
...
using _Navigate_Result__ros_msg_type = ros2_pkg__action__Navigate_Result;
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_pkg__action__Navigate_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_pkg
size_t max_serialized_size_ros2_pkg__action__Navigate_Result(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_pkg__action__Navigate_Result;
    is_plain =
      (
...
static size_t _Navigate_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_pkg__action__Navigate_Result(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_pkg, action, Navigate_Result)() {
...
using _Navigate_Feedback__ros_msg_type = ros2_pkg__action__Navigate_Feedback;
  ...
  void * untyped_ros_message)
{
  ...
  _Navigate_Feedback__ros_msg_type * ros_message = static_cast<_Navigate_Feedback__ros_msg_type *>(untyped_ros_message);
  // Field name: distance_to_point
  {
    cdr >> ros_message->distance_to_point;
  }
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_pkg__action__Navigate_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_pkg
size_t max_serialized_size_ros2_pkg__action__Navigate_Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_pkg__action__Navigate_Feedback;
    is_plain =
      (
...
static size_t _Navigate_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_pkg__action__Navigate_Feedback(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_pkg, action, Navigate_Feedback)() {
...
// already included above
// #include "ros2_pkg/action/detail/navigate__functions.h"  // goal
...
using _Navigate_SendGoal_Request__ros_msg_type = ros2_pkg__action__Navigate_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, ros2_pkg, action, Navigate_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _Navigate_SendGoal_Request__ros_msg_type * ros_message = static_cast<_Navigate_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: goal_id
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_ros2_pkg__action__Navigate_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_pkg__action__Navigate_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_pkg
size_t max_serialized_size_ros2_pkg__action__Navigate_SendGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ros2_pkg__action__Navigate_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_pkg__action__Navigate_SendGoal_Request;
    is_plain =
      (
...
static size_t _Navigate_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_pkg__action__Navigate_SendGoal_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_pkg, action, Navigate_SendGoal_Request)() {
...
using _Navigate_SendGoal_Response__ros_msg_type = ros2_pkg__action__Navigate_SendGoal_Response;
  ...
  void * untyped_ros_message)
{
  ...
  _Navigate_SendGoal_Response__ros_msg_type * ros_message = static_cast<_Navigate_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: accepted
  {
    uint8_t tmp;
    cdr >> tmp;
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_pkg__action__Navigate_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_pkg
size_t max_serialized_size_ros2_pkg__action__Navigate_SendGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_pkg__action__Navigate_SendGoal_Response;
    is_plain =
      (
...
static size_t _Navigate_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_pkg__action__Navigate_SendGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_pkg, action, Navigate_SendGoal_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_pkg, action, Navigate_SendGoal)() {
...
using _Navigate_GetResult_Request__ros_msg_type = ros2_pkg__action__Navigate_GetResult_Request;
  ...
  void * untyped_ros_message)
{
  ...
  _Navigate_GetResult_Request__ros_msg_type * ros_message = static_cast<_Navigate_GetResult_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: goal_id
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_pkg__action__Navigate_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_pkg
size_t max_serialized_size_ros2_pkg__action__Navigate_GetResult_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_pkg__action__Navigate_GetResult_Request;
    is_plain =
      (
...
static size_t _Navigate_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_pkg__action__Navigate_GetResult_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_pkg, action, Navigate_GetResult_Request)() {
...
// already included above
// #include "ros2_pkg/action/detail/navigate__functions.h"  // result
...
using _Navigate_GetResult_Response__ros_msg_type = ros2_pkg__action__Navigate_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, ros2_pkg, action, Navigate_Result
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _Navigate_GetResult_Response__ros_msg_type * ros_message = static_cast<_Navigate_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: status
  {
    cdr >> ros_message->status;
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_ros2_pkg__action__Navigate_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_pkg__action__Navigate_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_pkg
size_t max_serialized_size_ros2_pkg__action__Navigate_GetResult_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ros2_pkg__action__Navigate_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_pkg__action__Navigate_GetResult_Response;
    is_plain =
      (
...
static size_t _Navigate_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_pkg__action__Navigate_GetResult_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_pkg, action, Navigate_GetResult_Response)() {
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_pkg, action, Navigate_GetResult)() {
...
// already included above
// #include "ros2_pkg/action/detail/navigate__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _Navigate_FeedbackMessage__ros_msg_type = ros2_pkg__action__Navigate_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, ros2_pkg, action, Navigate_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _Navigate_FeedbackMessage__ros_msg_type * ros_message = static_cast<_Navigate_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  // Field name: goal_id
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_ros2_pkg__action__Navigate_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_pkg__action__Navigate_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_pkg
size_t max_serialized_size_ros2_pkg__action__Navigate_FeedbackMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ros2_pkg__action__Navigate_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_pkg__action__Navigate_FeedbackMessage;
    is_plain =
      (
...
static size_t _Navigate_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_pkg__action__Navigate_FeedbackMessage(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_pkg, action, Navigate_FeedbackMessage)() {
