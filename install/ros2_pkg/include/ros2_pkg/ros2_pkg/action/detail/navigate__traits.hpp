...
[[deprecated("use ros2_pkg::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const ros2_pkg::action::Navigate_Goal & msg,
  std::ostream & out, size_t indentation = 0)
{
  ros2_pkg::action::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use ros2_pkg::action::to_yaml() instead")]]
inline std::string to_yaml(const ros2_pkg::action::Navigate_Goal & msg)
{
  return ros2_pkg::action::to_yaml(msg);
}
