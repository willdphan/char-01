...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::ros2_pkg::srv::TurnCamera_Response camera_image(::ros2_pkg::srv::TurnCamera_Response::_camera_image_type arg)
  {
...
{
  return ros2_pkg::srv::builder::Init_TurnCamera_Response_camera_image();
}
