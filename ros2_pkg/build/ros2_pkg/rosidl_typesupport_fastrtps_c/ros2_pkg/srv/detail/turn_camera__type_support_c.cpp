  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_pkg__srv__TurnCamera_Request;
    is_plain =
      (
...
static size_t _TurnCamera_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_pkg__srv__TurnCamera_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_pkg__srv__TurnCamera_Response;
    is_plain =
      (
...
static size_t _TurnCamera_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_pkg__srv__TurnCamera_Response(
    full_bounded, is_plain, 0);
