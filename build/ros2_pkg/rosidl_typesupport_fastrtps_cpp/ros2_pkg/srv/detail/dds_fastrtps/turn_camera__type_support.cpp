...
#include "ros2_pkg/srv/detail/turn_camera__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros2_pkg::srv::TurnCamera_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_pkg::srv::TurnCamera_Request & ros_message)
{
  // Member: degree_turn
  cdr >> ros_message.degree_turn;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_pkg::srv::TurnCamera_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_pkg::srv::TurnCamera_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_pkg::srv::TurnCamera_Request *>(
    untyped_ros_message);
...
{
  return &ros2_pkg::srv::typesupport_fastrtps_cpp::_TurnCamera_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_pkg, srv, TurnCamera_Request)() {
  return &ros2_pkg::srv::typesupport_fastrtps_cpp::_TurnCamera_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros2_pkg
cdr_serialize(
  const ros2_pkg::srv::TurnCamera_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: camera_image
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_pkg::srv::TurnCamera_Response & ros_message)
{
  // Member: camera_image
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_pkg::srv::TurnCamera_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_pkg::srv::TurnCamera_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros2_pkg::srv::TurnCamera_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ros2_pkg::srv::typesupport_fastrtps_cpp::_TurnCamera_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_pkg, srv, TurnCamera_Response)() {
  return &ros2_pkg::srv::typesupport_fastrtps_cpp::_TurnCamera_Response__handle;
}
...
{
  return &ros2_pkg::srv::typesupport_fastrtps_cpp::_TurnCamera__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_pkg, srv, TurnCamera)() {
  return &ros2_pkg::srv::typesupport_fastrtps_cpp::_TurnCamera__handle;
}
