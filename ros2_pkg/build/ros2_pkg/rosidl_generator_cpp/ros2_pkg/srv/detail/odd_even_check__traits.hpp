...
[[deprecated("use ros2_pkg::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const ros2_pkg::srv::OddEvenCheck_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
  ros2_pkg::srv::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use ros2_pkg::srv::to_yaml() instead")]]
inline std::string to_yaml(const ros2_pkg::srv::OddEvenCheck_Request & msg)
{
  return ros2_pkg::srv::to_yaml(msg);
}
